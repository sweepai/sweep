                    ...
                    match event, action:
                                ...
                                if (
                                    ...
                                    for check_suite in check_suites:
                                        if check_suite.conclusion == "failure":
                                            ...
                                            break
                                if (
                                    not (time.time() - pr.created_at.timestamp())
                                    > 60 * 15
                                ):
                        ...
                        case "installation_repositories", "added":
                            ...
                            try:
                                ...
                                logger.exception(
                                    f"Failed to add config to top repos: {e}"
                                )
                        ...
                        case "installation", "created":
                            repos_added_request = InstallationCreatedRequest(
                                **request_dict
                            )
                        ...
                        case "push", None:
                            if (
                                ...
                                ref = (
                                    request_dict["ref"] if "ref" in request_dict else ""
                                )
