...
class TestGraph(unittest.TestCase):
    def setUp(self):
        self.graph = Graph(definitions_graph=nx.DiGraph(), references_graph=nx.DiGraph())
...
def test_traverse_folder():
    with patch('os.walk') as mock_walk, patch('builtins.open', new_callable=mock_open, read_data='import os\nclass Test:\n    pass\ndef test_func():\n    pass\nos.path.join()') as mock_file:
