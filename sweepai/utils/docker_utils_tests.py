...
class TestDockerUtils(unittest.TestCase):
    ...
    def test_get_latest_docker_version_empty_response(self, mock_traceback, mock_get):
    ...
    @mock.patch('requests.get')
    @mock.patch('traceback.print_exc')
    def test_get_latest_docker_version_invalid_response(self, mock_traceback, mock_get):
