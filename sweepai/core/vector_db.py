...
def get_deeplake_vs_from_repo(
    ...
    def calculate_score(file_list, file_path, contents, repo_name, branch_name, cache_inst, cache_success):
        if len(file_list) > MAX_FILES:
            return (1, 2, 5) # This is a low score
        try:
    ...
    for file in tqdm(file_list):
        ...
        with open(file, "r") as f:
            ...
            score_factors.append(calculate_score(file_list, file_path, contents, repo_name, branch_name, cache_inst, cache_success))
