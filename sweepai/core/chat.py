...
class ChatGPT(BaseModel):
    ...
    def chat(
        ...
        # Calculate the total tokens in the messages
        ...
        # If the total tokens exceed the model's limit, remove messages from the beginning of the list
        while total_tokens > model_to_max_tokens[model]:
            total_tokens -= count_tokens.call(self.messages[0].content or "")
            self.messages.pop(0)
