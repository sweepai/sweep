...
class CodeGenBot(ChatGPT):
    ...
    def generate_files_to_change(self, retries):
    ...
    def create_file_instructions_dict(self, file_change_requests):
    ...
    def get_files_to_change(self, retries=2):
        file_change_requests, create_thoughts, modify_thoughts = self.generate_files_to_change(retries)
        file_change_requests = self.create_file_instructions_dict(file_change_requests)
