...
class CodeGenBot(ChatGPT):
    ...
    def generate_files_to_change_response(self, retries=2):
    ...
    def process_files_to_change_response(self, files_to_change):
    ...
    def get_files_to_change(self, retries=2):
        files_to_change = self.generate_files_to_change_response(retries)
        return self.process_files_to_change_response(files_to_change)
