...
class GithubBot(BaseModel):
    ...
    def create_branch(self, branch: str) -> str:
        ...
        try:
            ...
            logger.error("Resource not accessible by integration. Please check the permissions of the GitHub App.")
            raise e
        logger.error(f"Error: {e}, trying with other branch names...")
...
# Remove the xml tags and return the repaired user_code
user_code = '''
import json
from loguru import logger
import github
