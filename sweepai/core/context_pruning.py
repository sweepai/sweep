...
from sweepai.core.prompts import pruning_prompt, system_message_prompt, repo_description_prefix_prompt
...
class ContextPruning(ChatGPT):
    def prune_context(self, human_message: HumanMessagePrompt, **kwargs) -> list[str]:
        try:
            ...
            self.model = "gpt-4-32k" if self.chat_logger.is_paying_user() else "gpt-3.5-turbo-16k"
