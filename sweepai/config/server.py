...
OPENAI_API_KEY_GPT35 = os.environ.get("OPENAI_API_KEY_GPT35", None)
OPENAI_API_ENGINE_GPT35 = os.environ.get("OPENAI_API_ENGINE_GPT35", None)
OPENAI_API_KEY_GPT4 = os.environ.get("OPENAI_API_KEY_GPT4", None)
OPENAI_API_ENGINE_GPT4 = os.environ.get("OPENAI_API_ENGINE_GPT4", None)
OPENAI_API_KEY_GPT4_32K = os.environ.get("OPENAI_API_KEY_GPT4_32K", None)
