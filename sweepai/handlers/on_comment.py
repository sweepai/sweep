...
def on_comment(
    ...
    capture_posthog_event(username, "started", properties=metadata, start_time=start_time)
    ...
    capture_posthog_event(username, "success", properties={**metadata}, start_time=start_time)
    logger.info("on_comment success")
    return {"success": True}


def capture_posthog_event(username, event, properties, start_time=None):
    properties['duration'] = time.time() - start_time if start_time else 0
