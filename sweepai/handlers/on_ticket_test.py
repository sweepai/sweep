...
class TestOnTicket(unittest.TestCase):
    ...
    @patch("sweepai.handlers.on_ticket.get_github_client")
    def test_on_ticket_empty_summary(self, mock_get_github_client):
        mock_get_github_client.return_value = (Mock(), Mock())
        self.issue.summary = ""
        result = on_ticket(
            self.issue.title,
    ...
    @patch("sweepai.handlers.on_ticket.get_github_client")
    def test_on_ticket_no_description(self, mock_get_github_client):
        mock_get_github_client.return_value = (Mock(), Mock())
        self.issue.repo_description = ""
        result = on_ticket(
            self.issue.title,
    ...
    @patch("sweepai.handlers.on_ticket.get_github_client")
    def test_on_ticket_edited_issue(self, mock_get_github_client):
        mock_get_github_client.return_value = (Mock(), Mock())
    ...
    @patch("sweepai.handlers.on_ticket.get_github_client")
    def test_on_ticket_comment_id(self, mock_get_github_client):
        mock_get_github_client.return_value = (Mock(), Mock())
    ...
    @patch("sweepai.handlers.on_ticket.get_github_client")
    def test_on_ticket_tracking_id(self, mock_get_github_client):
        mock_get_github_client.return_value = (Mock(), Mock())
        self.issue.tracking_id = "test_tracking_id"
        result = on_ticket(
            self.issue.title,
            self.issue.summary,
            self.issue.issue_number,
