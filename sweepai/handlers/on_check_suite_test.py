...
from sweepai.handlers.on_check_suite import download_logs, clean_logs, on_check_suite
...
class TestOnCheckSuite(unittest.TestCase):
    ...
    def test_clean_logs(self):
        ...
        self.assertEqual(cleaned_logs, 'The command:\nTest command\nyielded the following error:\nTest error\n\nHere are the logs:\nTest logs')
        self.assertEqual(user_message, 'The command:\n`Test command`\nyielded the following error:\n`Test error`\nHere are the logs:\n```\nTest logs\n```')
