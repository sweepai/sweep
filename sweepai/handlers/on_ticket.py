...
def on_ticket(
    ...
    try:
        ...
        payment_message, payment_message_start = create_payment_messages(user_type, model_name, gpt_tickets_left_message, daily_message, tracking_id, is_paying_user, single_payment_link, pro_payment_link)
