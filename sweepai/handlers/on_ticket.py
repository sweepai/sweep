...
def on_ticket(
    ...
    try:
        ...
        payment_message_start = construct_payment_message(use_faster_model, is_paying_user, is_consumer_tier, daily_ticket_count, ticket_count)
...
def construct_payment_message(use_faster_model, is_paying_user, is_consumer_tier, daily_ticket_count, ticket_count):
