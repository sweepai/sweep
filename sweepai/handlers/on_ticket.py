...
def on_ticket(
    ...
    try:
        ...
        try:
            ...
            logger.exception("Failed to extract docs: {}", e)
        ...
        try:
            ...
            logger.exception("Max Tokens Exceeded: {}", e)
            ...
            logger.exception("Invalid Request Error occurred: {}", e)
            edit_sweep_comment(
                (
        ...
        if delete_branch:
            try:
                ...
                logger.exception("An error occurred while deleting branch: {}", e)
