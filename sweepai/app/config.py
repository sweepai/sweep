...
class SweepChatConfig(BaseModel):
    ...
    # The create method handles the OAuth process with Github and creates a new configuration.
    @classmethod
    def create(cls):
    ...
    # The load method loads the configuration from a file, or creates a new one if it doesn't exist.
    @classmethod
