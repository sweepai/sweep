...
class SweepChatConfig(BaseModel):
    ...
    github_pat: str  # The personal access token (PAT) for authentication
    repo_full_name: str | None = None  # The full name of the repository (e.g., "owner/repo")
    installation_id: int | None = None  # The installation ID of the GitHub App
    version: str = "0.0.1"  # The version of the application
