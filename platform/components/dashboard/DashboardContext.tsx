            ...
            <div className="flex flex-col h-full mt-32 items-center">
                ...
                <div className="max-w-[1800px] mt-8 flex justify-center flex-wrap align-items-start">
                    {searchedSnippets.map((snippet) => (
                        <>
                            <div key={`${snippet.file}:${snippet.start}:${snippet.end}`} className="border p-4 rounded-xl border p-4 rounded-xl w-[30%] min-w-[300px] m-2">

                                <div className="mb-2 text-blue-400">
                                    <code className="whitespace-pre-wrap">{snippet.file}:{snippet.start}:{snippet.end}</code>
                                </div>
                                <CodeMirror
                    ...
                    {searchedSnippets.length === 0 && !searchIsLoading && (
                        "No results found."
                    )}
                </div>
            </div>
