...
const DashboardDisplay = ({ filePath, setScriptOutput, file, setFile, repoName, setRepoName} : { filePath: string, setScriptOutput: any, file: string, setFile: any, repoName: string, setRepoName: any }) => {
