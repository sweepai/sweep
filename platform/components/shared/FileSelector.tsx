...
const FileSelector = (
    { filePath, setFilePath, file, setFile, hideMerge, setHideMerge, oldFile, setOldFile, repoName, files, setFiles, blockedGlobs }
    ...
    files: {label: string, name: string}[], setFiles: any, blockedGlobs: any } ) => {
    ...
    useEffect(() => {
        (async () => {
            let newFiles = await getFiles(repoName, blockedGlobs)
