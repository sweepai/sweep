...
const listFiles = async (rootDir: string, fileLimit: number = limit): Promise<File[]> => {
...
const getIndex = async (rootDir: string, fileLimit: number = limit): Promise<Fuse<Snippet>> => {
...
const searchFiles = async (rootDir: string, query: string, fileLimit: number = limit, searchLimit: number = limit): Promise<Snippet[]> => {
