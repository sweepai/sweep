...
def send_simple_reply(comment, g):
    """
    This method sends a simple reply to the user's comment.
    """
    # Use the pygithub library to send a simple response to the user
    g.create_issue_comment(comment)
...
def on_comment(
    ...
    try:
        ...
        # Call the new method to send a simple reply to the user
        send_simple_reply(comment, g)
