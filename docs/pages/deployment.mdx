...
We recommend using Docker Compose for most development as it provides a more accurate reflection of the production environment. However, if you need to test changes quickly and in isolation, running uvicorn directly can be a faster option.
