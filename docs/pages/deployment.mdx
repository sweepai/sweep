...
[![Video](http://img.youtube.com/vi/lIF0iVj4ow4/0.jpg)](https://www.youtube.com/watch?v=lIF0iVj4ow4 "Deploying Sweep Video Guide")

After finishing the steps in the video, please complete the `Set Webhook URL in GitHub` step once your Digital Ocean instance has finished deploying.
