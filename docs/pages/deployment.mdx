...
Create [GitHub App here](https://create-sweep-app.vercel.app/) (3 minutes). This tool will guide you through the process of creating a GitHub App, create a license key, and provide you with the necessary `.env` file.
