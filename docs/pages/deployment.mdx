...
1. Creating the GitHub App and getting a license key.
2. Hosting the Sweep backend on a cloud provider like DigitalOcean.

The license key is valid for 14 days and can be renewed by contacting us at team@sweep.dev. Feel free to reach out to us for any help or questions.
