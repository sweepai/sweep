...
This is the guide for self-deploying Sweep. If you would like to use our hosted version, please visit https://sweep.dev. If you would like to develop on Sweep, check out [development](https://github.com/sweepai/sweep?tab=readme-ov-file#development).
...
## Docker Version Update Information

In our continuous effort to improve Sweep, we regularly update the Docker version that Sweep runs on. To keep you informed about these updates, we have added a new feature that shows how recently the Docker version was updated. This information is displayed as a badge on the ticket.

Knowing the Docker version update information can be useful in several ways:

- It helps you understand the environment in which Sweep is running, which can be important for debugging and troubleshooting.
- It gives you an idea of how actively we are maintaining and updating Sweep.
- If you are self-hosting Sweep, it can help you decide when to pull the latest Docker image to keep your Sweep instance up-to-date.

Remember, staying updated with the latest Docker version ensures that you benefit from all the latest features, improvements, and bug fixes in Sweep.
