...
You can self-host Sweep by deploying our Docker image at https://ghcr.io/sweepai/sweep.

## 0. Pre-requisites

You need an OpenAI API key, preferably with GPT-4 32k, and GitHub developer mode.
