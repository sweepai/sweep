...
After about 5 minutes, Sweep will make a PR to your Docusaurus fork. If you go to the PR, you will see a Vercel preview.
...
If the PR is mostly right but you want to do some tweaking, you can **leave a comments on the PR or code** and Sweep will address the comments, also generating a new preview, like the following:
