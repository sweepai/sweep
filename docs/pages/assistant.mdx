...
We collect telemetry by default to improve the assistant, including data regarding what types of tasks you're asking Sweep to handle.

If you would like to disable telemetry, you need to add `NO_TELEMETRY=true` to your `.env` in your Sweep Assistant directory.
