...
We’re not concerned about this anymore, we learned a lot of the difficulty is in doing this well. If someone is able to copy Sweep and build faster than us, they likely don't need Sweep to do that.
...
It took us about 24 hours to setup a working version on FastAPI + Docker. We’re also going to provide instructions for using Sweep with long-context OSS models like CodeLlama/WizardCoder.
...
- https://docs.sweep.dev/usage/deployment
