...
```python {16-22, 26-55, 58-74} /EXTRACTED -> prepare_lexical_search_index/ /EXTRACTED -> compute_vector_search_scores/ /EXTRACTED -> prepare_documents_metadata_ids/ showLineNumbers
