...
And personally, I'd rather have unit tests for my messy orchestration function than a small util that rarely changes.
We decided that we’d set out on a simple task for the Halloween weekend: get Sweep to refactor our own code.
...
### Fuzzy matching helps with hallucinations
...
### Tricking GPT4 into thinking someone else will do it's work
