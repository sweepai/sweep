...
Generate a summary of the repository using [ctag summaries](https://docs.sweep.dev/usage/advanced) of the top 10 files from the re-ranking, which is a summary of the variable names and functions declared in the file.
...
See more at https://docs.sweep.dev/usage/advanced.
...
We have a more details tour of our search infrastructure at https://docs.sweep.dev/blogs/search-infra and https://docs.sweep.dev/usage/advanced.
