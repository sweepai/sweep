...
Our [`RegexExtractModel`](https://github.com/sweepai/sweep/blob/main/sdk/src/agent.py#L17) parses this into a string, but we also need custom logic to handle the above edge cases.<br></br>
...
Try it out by copying the code from https://github.com/sweepai/sweep/blob/main/sdk/src/agent.py or installing the package with `pip install sweep-sdk`. We'd love to hear your feedback!
