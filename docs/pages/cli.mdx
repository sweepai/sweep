...
{/* Add instructions for eslint setup (npm install -g prettier typescript eslint @typescript-eslint/parser @typescript-eslint/eslint-plugin eslint-plugin-import) */}
