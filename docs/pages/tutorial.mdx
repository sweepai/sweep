...
![Initial](/tutorial/initial.png)
    ...
    a. If the PR's preview looks completely wrong, you can **add more details to the issue description or title** and Sweep will make a new PR with a new preview like the following:
...
Now to be a Sweep power user, check out [Prompting Sweep](https://docs.sweep.dev/recipes) and [Sweep Configuration](https://docs.sweep.dev/config)
