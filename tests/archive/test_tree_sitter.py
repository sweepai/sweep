...
valid_syntax, error_message = check_syntax(file_path="test.py", code=content)
print(error_message)
...
function testFunc() {
  ...
  // Missing closing parenthesis for the console.log function
}
"""

valid_syntax, error_message = check_syntax(file_path=file_path, code=js_content)
print(error_message)
